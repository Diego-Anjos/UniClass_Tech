...
- [Propósito do Sistema](#-propósito-do-sistema)
- [Tech Stack](#-tech-stack)
- [Arquitetura de Módulos](#-arquitetura-de-módulos)
  - [🛡️ Módulo Admin — Secretaria Acadêmica](#️-módulo-admin--secretaria-acadêmica)
  - [👨‍🏫 Módulo Professor](#-módulo-professor)
  - [🎓 Módulo Aluno](#-módulo-aluno)
...
| **Insights de IA** | Módulo mais avançado — detalhado abaixo. |
...
| **Contato** | Central de contato direcionada automaticamente aos professores vinculados ao aluno, exibindo os **horários de atendimento** configurados por cada professor — eliminando a necessidade de buscar essa informação manualmente. |
...
- **`/aluno/dashboard`** → Acesso do estudante (autenticado via RA e senha)
