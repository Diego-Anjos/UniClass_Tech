          ...
          <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div className="min-w-0">
              ...
              <div className="mt-3 relative inline-block">
                ...
                >
                  <option value="bd-4-noturno">
                    Banco de Dados - 4º Semestre (Noturno)
                  </option>
                  <option value="es-3-matutino">
                    Engenharia de Software - 3º Semestre (Matutino)
                  </option>
                  <option value="alg-2-noturno">
                    Algoritmos - 2º Semestre (Noturno)
                  </option>
                </select>
          ...
          <div className="mb-8 rounded-xl bg-zinc-950 border border-indigo-900/50 p-5 flex gap-4">
            ...
            <div className="min-w-0">
              ...
              <p className="text-sm text-zinc-300 leading-relaxed">
                Análise da IA: A média da N1 desta turma está 12% abaixo da média histórica. Considere uma aula de revisão de Modelagem Relacional antes da N2.
              </p>
            </div>
          </div>
                  ...
                  {alunos.map((aluno) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-4 text-center">
                        <input
                          type="text"
                          defaultValue={aluno.n1}
                          className="w-16 h-8 mx-auto block bg-zinc-900 border border-zinc-800 rounded-md text-sm text-white text-center focus:outline-none focus:ring-1 focus:ring-zinc-500 focus:border-zinc-600"
                        />
                      </td>
                      <td className="px-4 py-4 text-center">
                        <input
                          type="text"
                          defaultValue={aluno.n2}
                          className="w-16 h-8 mx-auto block bg-zinc-900 border border-zinc-800 rounded-md text-sm text-white text-center focus:outline-none focus:ring-1 focus:ring-zinc-500 focus:border-zinc-600"
                        />
                      </td>
                      <td className="px-4 py-4 text-center">
                      ...
                      <td className="px-6 py-4 text-center">
                        <span
                          className={`inline-flex items-center px-2.5 py-0.5 rounded-md text-xs font-medium border ${statusStyles[aluno.status]}`}
                        >
                          {aluno.status}
                        </span>
                      </td>
